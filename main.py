...
# get row and col of given number in the 2d array
...
# get the (H) of A* formula using  Euclidian Distance
...
# get the all possible movement of the node by getting all adjacent nodes
...
# store the sortest path to print it
